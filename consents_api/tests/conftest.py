...
from consents_api.db.utils import create_database, drop_database
from consents_api.settings import settings
from consents_api.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from consents_api.db.meta import meta
    from consents_api.db.models import load_all_models
